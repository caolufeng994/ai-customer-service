...
from app.schemas.session import SessionCreate, SessionResponse, SessionDetailResponse, MessageResponse
...
async def update_session(
    ...
    try:
        session = SessionService.update_session(db, session_id, current_user.id, title)
        return ApiResponse.ok(
            data=SessionResponse.model_validate(session),
